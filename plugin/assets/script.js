const rates = {
        ...
        function calculate() {
            ...
            const monthlyRateFirstHalf = firstHalf / 24; // نرخ بهره ماهانه نیمه اول
            const monthlyRateSecondHalf = secondHalf / 24; // نرخ بهره ماهانه نیمه دوم
    
            // محاسبه قسط نیمه اول
            const monthlyPaymentFirstHalf = (amount * monthlyRateFirstHalf) / (1 - Math.pow(1 + monthlyRateFirstHalf, -22));
            // محاسبه قسط نیمه دوم
            const monthlyPaymentSecondHalf = (amount * monthlyRateSecondHalf) / (1 - Math.pow(1 + monthlyRateSecondHalf, -20));
